  ...
  return (
    <div className="box-border caret-transparent hidden min-h-0 min-w-0 outline-[3px] md:flex md:min-h-[auto] md:min-w-[auto]">
      ...
      <div className="box-border caret-transparent hidden outline-[3px]">
        <a
          href="https://riseatseven.com/connect-with-us/"
          className="relative text-white font-medium items-center bg-neutral-900 box-border caret-transparent gap-x-2 inline-flex flex-row-reverse shrink-0 justify-center tracking-[-0.4px] leading-5 outline-[3px] capitalize w-full border overflow-hidden px-6 py-3 rounded-3xl border-solid border-transparent md:w-auto"
        >
